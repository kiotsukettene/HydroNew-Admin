...
class HydroponicSetupSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($setups as $setup) {
            $deviceIndex = $setup['device_index'];
            unset($setup['device_index']);
            
            // Determine harvest_status based on growth_stage
            $harvestStatus = match($setup['growth_stage'] ?? '') {
                'harvest-ready', 'overgrown' => 'harvested',
                default => $setup['harvest_status'] ?? 'not_harvested'
            };
